...
public class WRCircleImageView extends ImageView {
    ...
    public WRCircleImageView(Context context) {
        super(context);

        init();
    }

    public WRCircleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WRCircleImageView(Context context, AttributeSet attrs, int defStyle) {
