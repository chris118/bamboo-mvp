...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private EasyProgress mProgressBar;
    ...
    private void initView(Context context) {
        ...
        headerTextView = findViewById(R.id.listview_header_text);

        //init the progress view
        mProgressBar = (EasyProgress) findViewById(R.id.listview_header_progressbar);
