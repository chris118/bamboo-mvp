...
//	private int waveColor = Color.argb(128, 70, 167, 119); //颜色
//	private int waveColor = Color.argb(128, 254, 216, 226); //颜色
	private int waveColor = Color.argb(128, 100, 182, 247); //颜色
	private int waveInterval = 120; //圆环的宽度
