...
/**
 * Created by chrisw on 2017/10/18.
 */
...
public class BasePopView {
    ...
    public void setBackgroundColor(@ColorInt int id) {
        if (id != 0) {
            rootView.setBackgroundColor(id);
        }
    }
        ...
        decorView.post(new Runnable() {
            ...
            public void run() {
                ...
                if (onDismissListener != null) {
                    onDismissListener.onDismiss(BasePopView.this);
                }
            }
        });
    ...
    public BasePopView setOnDismissListener(OnDismissListener onDismissListener) {
    ...
    protected BasePopView setOutSideCancelable(boolean isCancelable) {
        if (rootView != null) {
