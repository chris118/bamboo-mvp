...
import com.hh.bamboobase.utils.SDCardUtils;
...
/**
 * App信息工具
 * Created by chrisw on 2015/11/25.
 */
public final class AppUtils {
    ...
    public static String getCurrentRuntimeValue() {
        try {
            ...
            try {
                Method get = systemProperties.getMethod("getCopy", String.class, String.class);
                ...
                return "SystemProperties.getCopy(String key, String def) method is not found";
            }
